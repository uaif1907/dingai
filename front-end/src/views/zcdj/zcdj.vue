        ...
        <div class="zvdj-bottom">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="资产登记" name="second">
                    ...
                    <el-row>
                        <el-col :span="18">
                            <el-button type="primary" size="small" icon="el-icon-plus" @click="addDialogTableVisible=true">新增</el-button>
                            <el-button type="danger" size="small" icon="el-icon-delete" @click="restore">删除</el-button>
                    ...
                    <el-table :data="tableData.slice((currentPage-1)*pageSize,currentPage*pageSize)" border style="width: 100%;margin:10px 0;" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column fixed="right" label="操作" width="100">
                            <template slot-scope="scope">
                                ...
                                <el-button type="text" size="small" @click="editRegister(scope.$index,scope.row)">编辑</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    <!--              分页-->
